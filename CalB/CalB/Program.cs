...
class Program
{
    static void Main()
    {
        try
        {
            ...
            Console.WriteLine("");
            Console.WriteLine("Welocme to Scratches - Awotwi calculator. ");
            Console.WriteLine("");
            Console.WriteLine("Ready? Let Go! ");
            Console.WriteLine();
            ...
            while (true)
            {
                ...
                while (true)
                {
                    Console.Write("Do you want to continue with another calculation? (Y/N): ");
                    string continueInput = Console.ReadLine().ToUpper();

                    if (continueInput == "Y")
                    {
                        break; // Continue with another calculation
                    }
